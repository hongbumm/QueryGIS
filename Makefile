...
SOURCES = \
	__init__.py \
	query_gis.py query_gis_dialog.py

PLUGINNAME = query_gis

PY_FILES = \
	__init__.py \
	query_gis.py query_gis_dialog.py

UI_FILES = query_gis_dialog_base.ui
...
QGISDIR=C:\Users\juseo\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
